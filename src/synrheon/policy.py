"""Trainable cognitive-policy primitives retained from the E011-A assay.

This module owns learned operation/target selection from explicit revealed state.
It is a reusable donor mechanism for Ground 0 routing, not the complete cognition
process. Hidden experiment truth must never enter these policy features.
"""
