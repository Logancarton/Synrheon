"""Explicit cognitive substrate and observable organism state.

This module stores state. It does not choose cognitive routes. Ground 0 cognition
may read and write legitimate state through explicit owner boundaries, while runtime
remains a thin sequencer.
"""
...
class CognitiveSubstrate:
    ...
    def set_activation(self, concept_id: str, value: float) -> None:
        """Store supplied activation without choosing how cognition should think."""
