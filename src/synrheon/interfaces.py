"""External browser/API boundary for the Synrheon development organism.

This module translates HTTP requests into runtime commands and serves the development
UI. It does not interpret stimuli or own cognitive state.
"""
...
class DevelopmentRequestHandler(BaseHTTPRequestHandler):
    ...
    def log_message(self, format: str, *args: Any) -> None:
        """Keep the local development console quiet except for startup/errors."""
        return
